...
CREATE TABLE corridas (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,       -- ID da corrida (chave primária, gerada automaticamente)
    ...
    status VARCHAR(20) DEFAULT 'PENDENTE' NOT NULL, -- Status da corrida (PENDENTE por padrão)
